...
In order to support loading of multiple wallets in ventura-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ventura.cpp.
...
Changes to ventura.cpp
----------------------
ventura.cpp is the entry point into ventura-qt, and as such, will require some minor modifications to provide hooks for
