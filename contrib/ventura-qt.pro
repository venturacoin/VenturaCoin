...
RESOURCES += src/qt/ventura.qrc src/qt/ventura_locale.qrc

TRANSLATIONS += src/qt/locale/ventura_bg.ts \
                src/qt/locale/ventura_de.ts \
                src/qt/locale/ventura_en.ts \
                src/qt/locale/ventura_es.ts \
                src/qt/locale/ventura_fi.ts \
                src/qt/locale/ventura_fr.ts \
                src/qt/locale/ventura_it.ts \
                src/qt/locale/ventura_ja.ts \
                src/qt/locale/ventura_pl.ts \
                src/qt/locale/ventura_pt.ts \
                src/qt/locale/ventura_ru.ts \
                src/qt/locale/ventura_sk.ts \
                src/qt/locale/ventura_sv.ts \
                src/qt/locale/ventura_vi.ts \
                src/qt/locale/ventura_zh_CN.ts \
                src/qt/locale/ventura_zh_TW.ts
