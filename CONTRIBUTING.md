Contributing to Ventura Core
============================

The Ventura Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ventura Core project, and is not to be
confused with overall Ventura Network Protocol consensus changes.

Whether a pull request is merged into Ventura Core rests with the project merge
...
Patches that change Ventura consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ventura consensus, it must have been
...
The project leader is the release manager for each Ventura Core release.
