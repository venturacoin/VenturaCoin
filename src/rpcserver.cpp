...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Ventura server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ventura features */
        {"ventura", "masternode", &masternode, true, true, false},
        {"ventura", "listmasternodes", &listmasternodes, true, true, false},
        {"ventura", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ventura", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ventura", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ventura", "masternodedebug", &masternodedebug, true, true, false},
        {"ventura", "startmasternode", &startmasternode, true, true, false},
        {"ventura", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ventura", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ventura", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ventura", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ventura", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ventura", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ventura", "mnbudget", &mnbudget, true, true, false},
        {"ventura", "preparebudget", &preparebudget, true, true, false},
        {"ventura", "submitbudget", &submitbudget, true, true, false},
        {"ventura", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ventura", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ventura", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ventura", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ventura", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ventura", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ventura", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ventura", "checkbudgets", &checkbudgets, true, true, false},
        {"ventura", "mnsync", &mnsync, true, true, false},
        {"ventura", "spork", &spork, true, true, false},
        {"ventura", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ventura", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use venturad, or the -server option to ventura-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ventura-cli " + methodname + " " + args + "\n";
}
