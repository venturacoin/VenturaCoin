                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ventura Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ventura address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ventura: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZVT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ventura Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ventura Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ventura"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ventura addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ventura addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ventura: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ventura Core help message to get a list with possible Ventura command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ventura Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ventura network", "", count));
}
...
{
    QString strTitle = tr("Ventura Core"); // default title
...
/** Creates context menu, its actions, and venturas up all the relevant signals for mouse events. */
