...
/** Utility functions used by the Ventura Qt UI.
 */
namespace GUIUtil
{
...
// Render Ventura addresses in monospace font
...
// Parse "ventura:" URI into recipient object, return true on successful parsing
